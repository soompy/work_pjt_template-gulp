...
const devPath = {
    ...
    fonts: dev + '/fonts/**/*',
    sprite: dev + '/images/icons/*.{gif,png,jpeg,jpg,svg}',
}, buildPath = {
    html: build+ '/html',
    css: build + '/css',
    js: build + '/js',
...
gulp.task('default', gulp.series('jsCompile', 'jsUtilCompile', 'scssCompile', 'htmlComplie', 'imgMinCompile','sprite', 'fontCompile', gulp.parallel('watch', 'server')));